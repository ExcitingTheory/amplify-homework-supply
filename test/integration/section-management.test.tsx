...
// Create a shared mock client instance so test and component see the same object
...
vi.mock('../../src/utils/amplifyClient', () => ({
  getAmplifyClient: vi.fn(() => mockClientInstance),
}));
    ...
    const handleSave = async () => {
      ...
      if (selectedSection?.id) {
        ...
        if (result?.data) {
          ...
          // Also create Cognito group for the section
          if (client.mutations?.createSectionGroup) {
            await client.mutations.createSectionGroup({
              name: nameInput?.value,
