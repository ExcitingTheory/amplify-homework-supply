...
- Name: section-join-code.spec.ts >> Section Join Code – Simultaneous Users >> instructor creates section, student joins, instructor sees member appear
- Location: e2e-collaboration/section-join-code.spec.ts:33:7
