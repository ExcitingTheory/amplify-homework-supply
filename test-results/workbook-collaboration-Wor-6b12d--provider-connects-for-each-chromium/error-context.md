...
- Name: workbook-collaboration.spec.ts >> Workbook Collaboration – Simultaneous Users >> both users open same workbook, Yjs provider connects for each
- Location: e2e-collaboration/workbook-collaboration.spec.ts:40:7
