...
const TASKS = {
  pages: {
    ...
    items: [
      {
        id: "index-page",
        label: "Explore the Units index page",
        required: true,
      },
      {
        id: "unit-page",
        label: "Understand Unit detail page layout",
        required: true,
      },
      {
        id: "workbook-page",
        label: "Learn the Workbook (student view)",
        required: true,
      },
      {
        id: "sections-page",
        label: "Understand Sections/Classes page",
        required: false,
      },
      {
        id: "navigation",
        label: "Understand page navigation patterns",
        required: false,
      },
    ],
  },
  creation: {
    ...
    items: [
      {
        id: "create-section",
        label: "Create a Section (class) manually",
        required: true,
      },
      {
        id: "add-students",
        label: "Add students to section with join code",
        required: true,
      },
      { id: "create-unit", label: "Create a Unit manually", required: true },
      {
        id: "publish-unit",
        label: "Publish a unit for student access",
        required: false,
      },
      {
        id: "create-assignment",
        label: "Create an Assignment for a section",
        required: true,
      },
      {
        id: "set-due-date",
        label: "Set assignment due dates",
        required: false,
      },
    ],
  },
    ...
    items: [
      {
        ...
        label: "Use chat to generate section structure",
        required: false,
      },
      {
        id: "chat-create-unit",
        label: "Use chat to generate unit outline",
        required: true,
      },
      {
        id: "chat-build-content",
        label: "Have AI build unit content step-by-step",
        required: true,
      },
      {
        id: "chat-create-assignment",
        label: "Use chat to create and configure assignment",
        required: false,
      },
      {
        id: "iterate-content",
        label: "Iterate on AI-generated content with feedback",
        required: false,
      },
    ],
  },
  editor: {
    ...
    items: [
      {
        id: "editor-basics",
        label: "Understand Lexical editor structure",
        required: true,
      },
      { id: "add-content", label: "Add text and media blocks", required: true },
      {
        id: "quiz-blocks",
        label: "Create Quiz blocks (multiple choice)",
        required: true,
      },
      {
        id: "answer-blocks",
        label: "Create Answer blocks (fill-in-blank)",
        required: true,
      },
      {
        id: "meaning-association",
        label: "Use Meaning Association blocks",
        required: false,
      },
      {
        id: "custom-answer",
        label: "Use Custom Answer blocks",
        required: false,
      },
      {
        id: "markdown-shortcuts",
        label: "Use markdown shortcuts (##, -, *, etc.)",
        required: false,
      },
    ],
  },
    ...
    items: [
      {
        ...
        label: "Complete an assignment as student",
        required: true,
      },
      {
        id: "answer-questions",
        label: "Answer graded questions",
        required: true,
      },
  ...
  ai: {
    ...
    items: [
      ...
      {
        id: "understand-forms",
        label: "Understand suggested content forms",
        required: true,
      },
      {
        id: "insert-suggestions",
        label: "Insert suggestions into editor",
        required: true,
      },
      {
        id: "chat-context",
        label: "Understand chat context (unit, files, dictionary)",
        required: false,
      },
      {
        id: "streaming",
        label: "Understand streaming responses",
        required: false,
      },
    ],
  },
  files: {
    ...
    items: [
      {
        id: "upload-files",
        label: "Upload audio/video/image files",
        required: true,
      },
      {
        id: "organize-files",
        label: "Organize files with tags/categories",
        required: false,
      },
      {
        id: "file-protection",
        label: "Understand file protection levels (public/protected)",
        required: false,
      },
      {
        id: "use-files",
        label: "Reference files in editor content",
        required: true,
      },
      {
        id: "transcribe-audio",
        label: "Transcribe audio with Whisper",
        required: false,
      },
    ],
  },
  dictionary: {
    ...
    items: [
      {
        id: "add-words",
        label: "Add vocabulary words to dictionary",
        required: true,
      },
      {
        id: "word-audio",
        label: "Add audio pronunciation to words",
        required: false,
      },
      {
        id: "create-questions",
      ...
      {
        id: "question-types",
        label: "Understand question types (audio/drawing/text)",
        required: false,
      },
      {
        id: "link-to-unit",
        label: "Link words/questions to units",
        required: true,
      },
    ],
  },
  documents: {
    ...
    items: [
      ...
      {
        id: "extract-vocab",
        label: "Review extracted vocabulary",
        required: true,
      },
      {
        id: "import-vocab",
        label: "Import vocabulary to dictionary",
        required: true,
      },
      {
        id: "cancel-analysis",
        label: "Know how to cancel long-running analysis",
        required: false,
      },
    ],
  },
  search: {
    ...
    items: [
      ...
      {
        id: "semantic-search",
        label: "Understand semantic search (embeddings)",
        required: false,
      },
      {
        id: "filter-results",
        label: "Filter and sort search results",
        required: false,
      },
    ],
  },
  advanced: {
    ...
    items: [
      {
        id: "bulk-import",
        label: "Bulk import vocabulary from CSV",
        required: false,
      },
      {
        id: "grading-rubric",
        label: "Understand auto-grading rubric",
        required: false,
      },
      {
        id: "unit-templates",
        label: "Create reusable unit templates",
        required: false,
      },
      {
        id: "student-progress",
        label: "Track student progress analytics",
        required: false,
      },
    ],
  },
...
export function OnboardingGuide() {
  ...
  const requiredProgress =
    stats.required > 0 ? (stats.requiredCompleted / stats.required) * 100 : 100;
  ...
  const getAchievements = () => {
    ...
    if (stats.requiredCompleted === stats.required)
      achievements.push("✅ Core Complete");
      ...
      <div className="task-sections">
        {Object.entries(TASKS).map(([sectionId, section]) => {
          ...
          return (
            <div
              key={sectionId}
              className={`task-section ${isActive ? "active" : ""}`}
            >
              <div
