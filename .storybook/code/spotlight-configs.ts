...

  {
    ...
    tutorialSteps: [
      ...
      },
      {
        ...
        targetSelector: '[data-tour="section-view"]',
        tooltipPosition: 'bottom',
      },
      {
...

  {
    ...
    tutorialSteps: [
      ...
      },
      {
        ...
        targetSelector: '[data-tour="join-section-button"], button:has-text("Join")',
        tooltipPosition: 'bottom',
      },
      {
        id: 'join-code-input',
        ...
        targetSelector: '[data-tour="join-code-input"], input[placeholder*="code"]',
        tooltipPosition: 'top',
      },
      {
        id: 'confirm',
        ...
        targetSelector: '[data-tour="join-confirm"], button:has-text("Join")',
        tooltipPosition: 'top',
      },
      {
        id: 'complete',
