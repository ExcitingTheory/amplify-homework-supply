...
export const SPOTLIGHT_CONFIGURATIONS: SpotlightConfig[] = [
  ...
  
  {
    ...
    tutorialSteps: [
      ...
      },
      {
        ...
        target: '[data-tour="section-form"], form',
      ...
      },
      {
        ...
        target: '[data-tour="join-code"], [class*="joinCode"]',
...

  {
    ...
    tutorialSteps: [
      ...
      },
      {
        ...
        target: '[data-tour="create-unit-button"], button:has-text("Create Unit"), button:has-text("New Unit")',
        tooltipPosition: 'bottom',
        highlightPadding: 12,
        pulseTarget: true,
      },
      {
        ...
        target: '[data-tour="editor"], [class*="ContentEditable"]',
        tooltipPosition: 'top',
        highlightPadding: 16,
        actions: [
      ...
      },
      {
        ...
        target: '[data-tour="editor-toolbar"], [class*="toolbar"]',
        tooltipPosition: 'bottom',
        highlightPadding: 8,
      },
      {
        ...
        target: '[data-tour="save-button"], button:has-text("Save")',
        tooltipPosition: 'left',
        highlightPadding: 12,
        pulseTarget: true,
      },
...

  {
    ...
    tutorialSteps: [
      ...
      },
      {
        ...
        target: '[data-tour="quiz-block"], [class*="QuizNode"]',
        tooltipPosition: 'right',
        highlightPadding: 16,
        actions: [
      ...
      },
      {
        ...
        target: '[data-tour="quiz-answers"], [class*="answer"]',
        tooltipPosition: 'left',
        highlightPadding: 12,
      },
      {
        ...
        target: '[data-tour="correct-checkbox"], input[type="checkbox"]',
        tooltipPosition: 'left',
        highlightPadding: 8,
        pulseTarget: true,
      },
...

  {
    ...
    tutorialSteps: [
      ...
      },
      {
        ...
        target: '[data-tour="dictionary-editor"]',
        tooltipPosition: 'bottom',
        highlightPadding: 20,
      },
      {
        ...
        target: '[data-tour="add-word-button"], button:has-text("Add Word")',
        tooltipPosition: 'bottom',
        highlightPadding: 12,
        pulseTarget: true,
      },
      ...
      },
      {
        ...
        target: '[data-tour="audio-upload"], input[type="file"]',
        tooltipPosition: 'left',
        highlightPadding: 12,
      },
      {
...

  {
    ...
    tutorialSteps: [
      ...
      },
      {
        id: 'section-view',
        title: 'Your Section',
        description: 'Assignments are created within a section.',
        target: '[data-tour="section-view"]',
        tooltipPosition: 'bottom',
        highlightPadding: 20,
      },
      {
        ...
        description: 'Start assigning a unit to this class.',
        target: '[data-tour="create-assignment-button"], button:has-text("Create Assignment")',
        tooltipPosition: 'bottom',
        highlightPadding: 12,
        pulseTarget: true,
      },
      ...
      },
      {
        ...
        target: '[data-tour="due-date-picker"], input[type="date"], input[type="datetime-local"]',
        tooltipPosition: 'left',
        highlightPadding: 12,
        actions: [
      ...
      },
      {
        ...
        target: '[data-tour="assignment-settings"]',
        tooltipPosition: 'right',
        highlightPadding: 16,
        actions: [
...

  {
    ...
    tutorialSteps: [
      ...
      },
      {
        ...
        target: '[data-tour="grades-tab"], button:has-text("Grades"), [role="tab"]:has-text("Grades")',
        tooltipPosition: 'bottom',
        highlightPadding: 12,
        pulseTarget: true,
      },
...

  {
    ...
    tutorialSteps: [
      ...
      },
      {
        ...
        target: '[data-tour="chat-button"], button[aria-label*="chat"], button[aria-label*="AI"]',
        tooltipPosition: 'left',
        highlightPadding: 12,
        pulseTarget: true,
      },
      ...
      },
      {
        ...
        target: '[data-tour="insert-button"], button:has-text("Insert")',
        tooltipPosition: 'top',
        highlightPadding: 12,
        pulseTarget: true,
      },
...

  {
    ...
    tutorialSteps: [
      ...
      },
      {
        ...
        target: '[data-tour="shortcuts-page"]',
        tooltipPosition: 'bottom',
        highlightPadding: 20,
        actions: [
      ...
      },
      {
        ...
        target: '[data-tour="shortcuts-demo"]',
        tooltipPosition: 'right',
        highlightPadding: 16,
        actions: [
...

  {
    ...
    tutorialSteps: [
      ...
      {
        id: 'sections-page',
        title: 'Go to Sections',
        description: 'This is where you see all your classes.',
        target: '[data-tour="sections-page"]',
        tooltipPosition: 'bottom',
        highlightPadding: 20,
      },
      {
        ...
        description: 'Click to enter a join code.',
        target: '[data-tour="join-section-button"], button:has-text("Join")',
        tooltipPosition: 'bottom',
        highlightPadding: 12,
        pulseTarget: true,
      },
      {
        ...
        description: 'Type the code your instructor gave you.',
        target: '[data-tour="join-code-input"], input[placeholder*="code"]',
        tooltipPosition: 'top',
        highlightPadding: 12,
        pulseTarget: true,
      },
      {
        ...
        description: 'You\'ll be enrolled immediately.',
        target: '[data-tour="join-confirm"], button:has-text("Join")',
        tooltipPosition: 'top',
        highlightPadding: 12,
      },
      {
...

  {
    ...
    tutorialSteps: [
      ...
      },
      {
        ...
        target: '[data-tour="assignments-tab"], [role="tab"]:has-text("Assignments")',
        tooltipPosition: 'bottom',
        highlightPadding: 12,
        pulseTarget: true,
      },
...

  {
    ...
    tutorialSteps: [
      ...
      },
      {
        ...
        target: '[data-tour="submit-button"], button:has-text("Submit")',
        tooltipPosition: 'top',
        highlightPadding: 12,
        pulseTarget: true,
      },
...

  {
    ...
    tutorialSteps: [
      ...
      },
      {
        ...
        target: '[data-tour="correct-answers"]',
        tooltipPosition: 'left',
        highlightPadding: 16,
      },
      {
...

  {
    ...
    tutorialSteps: [
      ...
      },
      {
        ...
        target: '[data-tour="play-audio"], button[aria-label*="Play"]',
        tooltipPosition: 'left',
        highlightPadding: 12,
        pulseTarget: true,
      },
...

  {
    ...
    tutorialSteps: [
      ...
      },
      {
        ...
        target: '[data-tour="chat-button"], button[aria-label*="chat"]',
        tooltipPosition: 'left',
        highlightPadding: 12,
        pulseTarget: true,
      },
      {
        ...
        target: '[data-tour="chat-input"], textarea, input[placeholder*="message"]',
        tooltipPosition: 'top',
        highlightPadding: 12,
        actions: [
...

  {
    ...
    tutorialSteps: [
      ...
      },
      {
        ...
        target: '[data-tour="storybook-sidebar"], #storybook-explorer-tree',
        tooltipPosition: 'right',
        highlightPadding: 20,
        actions: [
          'Browse categories',
      ...
      },
      {
        ...
        target: '[data-tour="tech-overview"]',
        tooltipPosition: 'right',
        highlightPadding: 16,
      },
      {
        ...
        target: '[data-tour="docs-tab"], button:has-text("Docs")',
        tooltipPosition: 'bottom',
        highlightPadding: 12,
      },
      {
        ...
        target: '[data-tour="canvas-tab"], button:has-text("Canvas")',
        tooltipPosition: 'bottom',
        highlightPadding: 12,
      },
      {
...

  {
    ...
    tutorialSteps: [
      ...
      },
      {
        ...
        target: '[data-tour="editor-stories"]',
        tooltipPosition: 'right',
        highlightPadding: 16,
      },
      {
...

  {
    ...
    tutorialSteps: [
      ...
      },
      {
        ...
        target: '[data-tour="help-shortcuts"]',
        tooltipPosition: 'bottom',
        highlightPadding: 16,
        actions: [
          'Bookmark this page',
...

  {
    ...
    tutorialSteps: [
      ...
      },
      {
        ...
        target: '[data-tour="interactive-training"]',
        tooltipPosition: 'center',
        highlightPadding: 20,
        actions: [
