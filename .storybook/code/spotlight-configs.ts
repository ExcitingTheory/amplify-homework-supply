 ...
 */
export function getSpotlightConfigForTask(
  taskId: string,
  mode: "tutorial" | "quiz",
): SpotlightStep[] {
  ...
  const steps = mode === "tutorial" ? config.tutorialSteps : config.quizSteps;
  if (mode === "quiz") {
...
/**
 * Quiz mode uses a single guidance popup with no self-report/verification step.
 */
function normalizeQuizSteps(
  taskId: string,
  steps: SpotlightStep[],
): SpotlightStep[] {
  if (!steps || steps.length === 0) {
    return getDefaultSteps(taskId, "quiz");
  }

  const verifyPattern =
    /did you complete|mark complete|complete if|verify|successfully created\?/i;
  const nonVerify = steps.filter((step) => {
    const text = `${step.title} ${step.description}`;
    return !verifyPattern.test(text);
  });

  const primary = nonVerify[0] || steps[0];

  return [
    {
      ...primary,
      isLast: true,
      // Quiz mode should not spotlight specific components.
...

  {
    ...
    tutorialSteps: [
      {
        ...
        description:
          "This is your interactive training environment. The sidebar on the left organizes all the features you'll learn. Each story shows a working preview of a feature.",
    ...
    quizSteps: [
      ...
      },
      {
        ...
        description:
          "Mark this task complete if you successfully created a section.",
        tooltipPosition: "center",
        isLast: true,
      },
    ],
...

  {
    ...
    tutorialSteps: [
      ...
      },
      {
        ...
        title: "The Editor",
        description:
          "After creating a unit, you'll see the rich text editor. Use the toolbar to format content and insert blocks.",
        tooltipPosition: "center",
        actions: [
    ...
    tutorialSteps: [
      {
        ...
        description:
          "Create interactive questions that test student understanding.",
        tooltipPosition: "center",
        actions: [
      ...
      },
      {
        ...
        title: "Insert Menu",
        description:
          'Click the "+ Insert" button to open the block insertion menu.',
        targetSelector:
          '[aria-controls="insert-node-menu"], button[aria-label*="Insert"]',
        tooltipPosition: "bottom",
        actions: [
          'Click the "+ Insert" button in the toolbar',
      ...
      },
      {
        ...
        targetSelector:
          '[aria-label*="Multiple Choice Quiz"], [title*="Multiple Choice Quiz"]',
        tooltipPosition: "right",
        actions: [
      ...
      },
      {
        ...
        title: "Quiz Added! ✅",
        description:
          "Students will now answer this question when completing the unit.",
        tooltipPosition: "center",
        isLast: true,
      },
    ],
    quizSteps: [
      {
        ...
        description:
          'Use the "+ Insert" toolbar button to add a Multiple Choice Quiz block with at least 2 answer choices.',
        tooltipPosition: "center",
      },
      {
        id: "verify",
        title: "Quiz Created?",
        description:
          "Complete if you added a quiz with a marked correct answer.",
        tooltipPosition: "center",
        isLast: true,
      },
    ],
    ...
    tutorialSteps: [
      {
        ...
        description:
          "Add vocabulary words that students can practice and reference.",
        tooltipPosition: "center",
      },
      {
      ...
      },
      {
        ...
        description:
          "Associate this word with a unit so students can find it in context.",
        tooltipPosition: "left",
      },
      {
        id: "complete",
...

  {
    ...
    tutorialSteps: [
      ...
      },
      {
        ...
        description:
          "This dialog lets you create assignments for your section.",
        tooltipPosition: "center",
      },
      {
      ...
      },
      {
        ...
        targetSelector:
          '[data-tour="due-date-picker"], input[type="date"], input[type="datetime-local"]',
        tooltipPosition: "left",
        actions: [
...

  {
    ...
    tutorialSteps: [
      ...
      },
      {
        ...
        targetSelector:
          '[data-tour="chat-button"], button[aria-label*="chat"], button[aria-label*="AI"]',
        tooltipPosition: "left",
      },
      {
        id: "chat-sidebar",
...

  {
    ...
    tutorialSteps: [
      ...
      },
      {
        ...
        description:
          "Use your instructor's join code to enroll in their section.",
        tooltipPosition: "center",
      },
      {
        id: "join-button",
      ...
      },
      {
        ...
        description:
          "This dialog lets you join an instructor's class. Fill in the code and submit.",
      ...
      },
      {
        ...
        description:
          "Type the code your instructor gave you. In this demo, use DEMO-2026.",
      ...
      },
      {
        ...
        targetSelector:
          '[data-tour="join-section-dialog"] button[type="submit"]',
        tooltipPosition: "top",
        interactable: true,
      },
      {
...

  {
    ...
    tutorialSteps: [
      ...
      },
      {
        ...
        title: "The Workbook",
        description:
          'Read through the lesson content, answer quiz questions, record audio, and fill in blanks. Click "Next" when you\'re ready to continue.',
      ...
      },
      {
        ...
        description:
          "Work through lesson text, PDFs, and media before answering.",
        tooltipPosition: "bottom",
      },
      {
        id: "answer-questions",
      ...
      },
      {
        ...
        description:
          "If the assignment includes audio tasks, record your response here.",
        tooltipPosition: "left",
      },
      {
        id: "review-score",
    ...
    tutorialSteps: [
      {
        ...
        description:
          "Become a Keyboard Master by completing interactive training!",
        tooltipPosition: "center",
      },
      {
        id: "training-mode",
...

  {
    ...
    tutorialSteps: [
      ...
      },
      {
        ...
        description:
          "Learn how to preview content in each supported locale using the toolbar.",
      ...
      },
      {
        ...
        description:
          'The 🌐 globe icon labeled "Translation Mode" toggles highlight/edit mode. Click it to enable Translation Mode.',
        targetSelector:
          'button[title="Translation Mode"], button[title="Off"], button[title="Highlight"], button[title="Edit"]',
        targetFrame: "manager",
        tooltipPosition: "bottom",
      },
      {
        ...
        description:
          'Click the "Language" toolbar button to open the locale dropdown. Select a language to preview the UI in that locale.',
        targetSelector:
          'button[title="Language"], button[title="English"], button[title="en"], button[title="ja"], button[title="es"]',
        targetFrame: "manager",
        tooltipPosition: "bottom",
        actions: [
      ...
      },
      {
        ...
        description:
          "Look at the form below — text that did NOT change is untranslated.",
    ...
    quizSteps: [
      {
        ...
        description:
          "Switch to two different languages and identify at least one untranslated string.",
        tooltipPosition: "center",
      },
      {
        id: "verify",
    ...
    tutorialSteps: [
      {
        ...
        description:
          "The panel at the bottom of Storybook is your main translation workspace.",
        targetSelector: '[data-tour="translation-demo"]',
        tooltipPosition: "right",
        actions: [
      ...
      },
      {
        ...
        description:
          'Click the "Translations" tab in the addon panel below. If the panel is collapsed, click the horizontal bar at the bottom to expand it.',
        targetSelector:
          'button[role="tab"]#tabbutton-translation-mode-addon-translation-mode-panel, button[role="tab"][id*="translation"]',
        targetFrame: "manager",
        tooltipPosition: "top",
      },
      {
        ...
        description:
          "Each row in the Translations panel shows a key, its English value, and translation status per locale.",
      ...
      },
      {
        ...
        description:
          "Click a row in the panel to expand rich context: description, component, impact, tone.",
        targetSelector: '[data-tour="translation-auth-form"]',
        tooltipPosition: "top",
        actions: [
      ...
      },
      {
        ...
        description:
          'Use the "Export Translations" button in the Translations panel to download JSON or CSV files for offline editing.',
      ...
      },
      {
        ...
        description:
          "You now know where to find and edit all translation data.",
        tooltipPosition: "center",
        isLast: true,
      },
    ],
    quizSteps: [
      {
        ...
        description:
          "Open the Translations panel and expand at least one key to view its metadata.",
        tooltipPosition: "center",
      },
      {
        id: "verify",
    ...
    tutorialSteps: [
      {
        ...
        description:
          "Understand how translation JSON files are organized on disk.",
        targetSelector: '[data-tour="translation-demo"]',
        tooltipPosition: "right",
        actions: [
      ...
      },
      {
        ...
        title: "Key Format",
        description:
          "Keys are nested JSON objects mapped to dot-notation paths.",
        tooltipPosition: "center",
        actions: [
      ...
      },
      {
        ...
        description:
          'Navigate to the "Editor Namespace" story in the sidebar under Translation Mode/Demo. It shows how editor.json keys appear in the panel.',
        tooltipPosition: "center",
      },
      {
        id: "complete",
        ...
        description:
          "You now know where locale files live and how keys are organized.",
        tooltipPosition: "center",
        isLast: true,
      },
    ],
    quizSteps: [
      {
        ...
        description:
          "Find a key in the Translations panel and locate the corresponding file and path in public/locales/.",
        tooltipPosition: "center",
      },
      {
        id: "verify",
    ...
    tutorialSteps: [
      {
        ...
        description:
          "Use metadata to understand where and how each translated string appears in the UI.",
        targetSelector: '[data-tour="translation-demo"]',
        tooltipPosition: "right",
        actions: [
      ...
      },
      {
        ...
        description:
          "This story shows login/signup strings with rich context metadata. The auth form below contains translatable fields.",
        targetSelector: '[data-tour="translation-auth-form"]',
        tooltipPosition: "top",
      },
      {
        ...
        description:
          "In the Translations panel at the bottom, click any row to reveal the full metadata panel with context, tone, and usage info.",
        targetSelector:
          'button[role="tab"]#tabbutton-translation-mode-addon-translation-mode-panel, button[role="tab"][id*="translation"]',
        targetFrame: "manager",
        tooltipPosition: "top",
      },
      {
        ...
        description:
          "This describes when users see the text and why it matters.",
        tooltipPosition: "center",
        actions: [
    ...
    quizSteps: [
      {
        ...
        description:
          "Expand 3 translation rows and describe the tone and user type for each.",
        tooltipPosition: "center",
      },
      {
        id: "verify",
        ...
        description:
          "Complete if you used metadata to understand string usage.",
        tooltipPosition: "center",
        isLast: true,
      },
    ],
    ...
    tutorialSteps: [
      {
        ...
        description:
          "Verify that the UI renders correctly for right-to-left languages.",
        targetSelector: '[data-tour="translation-demo"]',
        tooltipPosition: "right",
        actions: [
      ...
      },
      {
        ...
        title: "Switch to RTL",
        description:
          "Select Arabic (ar) or Hebrew (he) from the Language toolbar button if available.",
        targetSelector:
          'button[title="Language"], button[title="English"], button[title="en"], button[title="ja"], button[title="es"]',
        targetFrame: "manager",
        tooltipPosition: "bottom",
      },
      {
        ...
        description:
          "The entire layout should flip — navigation on the right, content flowing right-to-left.",
        targetSelector: '[data-tour="translation-demo"]',
        tooltipPosition: "right",
        actions: [
      ...
      },
      {
        ...
        description:
          "Navigate to 2-3 different stories to verify RTL works everywhere.",
        tooltipPosition: "center",
        actions: [
      ...
      },
      {
        ...
        title: "Report Issues",
        description:
          "Note any elements that use left/right instead of start/end CSS properties.",
        tooltipPosition: "center",
        actions: [
    ...
    quizSteps: [
      {
        ...
        description:
          "Switch to an RTL language and navigate to at least 2 different stories.",
        tooltipPosition: "center",
      },
      {
        id: "verify",
    ...
    tutorialSteps: [
      {
        ...
        description:
          "Learn how i18next handles count-dependent translation forms.",
        targetSelector: '[data-tour="translation-demo"]',
        tooltipPosition: "right",
        actions: [
      ...
      },
      {
        ...
        description:
          "In the Translations panel, look for translation values containing {{count}} — these are pluralized.",
        targetSelector: '[data-tour="translation-auth-form"]',
        tooltipPosition: "top",
        actions: [
      ...
      },
      {
        ...
        description:
          "Verify the correct form is selected for each count value.",
        tooltipPosition: "center",
        actions: [
      ...
      },
      {
        ...
        description:
          "You understand how to handle count-dependent translations.",
        tooltipPosition: "center",
        isLast: true,
      },
    ],
    quizSteps: [
      {
        ...
        description:
          "Find a pluralized key and verify it has the correct suffix forms for both English and Japanese.",
        tooltipPosition: "center",
      },
      {
        id: "verify",
        ...
        description:
          "Complete if you checked plural forms for a key across locales.",
        tooltipPosition: "center",
        isLast: true,
      },
    ],
