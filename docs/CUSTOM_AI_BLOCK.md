...
A graded Lexical editor block type (`custom-ai`) providing instructor-customizable AI-graded exercises with security guardrails. Processes student input through OpenAI with instructor-defined grading criteria, enforcing an immutable interface and strict security boundaries.
