    ...
    <>
      ...
      >
        ...
        <Typography variant="body1" color="text.secondary" sx={{ mb: 3 }}>
          {t(
            "guilds.description",
            "Join a guild to compete with your team and climb the leaderboard together.",
          )}
        </Typography>
        ...
        >
          ...
          {!myGuild && (
            ...
            >
              {creating
                ? "Creating…"
                : t("guilds.createGuild", "Start a New Guild")}
            </Button>
          )}
        </Box>

        <GuildLeaderboard guilds={guildLeaderboard} myGuildId={myGuild?.id} />
      </Box>
    </>
  );
}
