...
export default function SectionAISettingsPage({
  ...
  const [section, setSection] = React.useState<any>(initialSection || null);
  ...
  const handleSave = React.useCallback(async () => {
    ...
    try {
      ...
      if (values.kaiMaxSteps != null) aiConfig.kaiMaxSteps = values.kaiMaxSteps;
  ...
  return (
    <Box
      data-testid="section-ai-settings"
      sx={{ maxWidth: "60rem", margin: "2rem auto", padding: "0 1rem" }}
    >
