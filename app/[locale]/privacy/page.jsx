          ...
          >
            ...
            <Box component="ul" sx={{ pl: 4 }}>
              <Typography component="li" variant="body1" paragraph>
                <strong>{t("privacy.informationWeCollect.accountInfo")}</strong>{" "}
                {t("privacy.informationWeCollect.accountInfoText")}
              </Typography>
              <Typography component="li" variant="body1" paragraph>
                <strong>
                  {t("privacy.informationWeCollect.learningData")}
                </strong>{" "}
                {t("privacy.informationWeCollect.learningDataText")}
              </Typography>
              <Typography component="li" variant="body1" paragraph>
                <strong>{t("privacy.informationWeCollect.userContent")}</strong>{" "}
                {t("privacy.informationWeCollect.userContentText")}
              </Typography>
              <Typography component="li" variant="body1" paragraph>
                <strong>{t("privacy.informationWeCollect.usageInfo")}</strong>{" "}
                {t("privacy.informationWeCollect.usageInfoText")}
              </Typography>
            </Box>
            ...
            <Box component="ul" sx={{ pl: 4 }}>
              <Typography component="li" variant="body1" paragraph>
                <strong>{t("privacy.dataSharing.instructors")}</strong>{" "}
                {t("privacy.dataSharing.instructorsText")}
              </Typography>
              <Typography component="li" variant="body1" paragraph>
                <strong>{t("privacy.dataSharing.classmates")}</strong>{" "}
                {t("privacy.dataSharing.classmatesText")}
              </Typography>
              <Typography component="li" variant="body1" paragraph>
                <strong>{t("privacy.dataSharing.aiProcessing")}</strong>{" "}
                {t("privacy.dataSharing.aiProcessingText")}
              </Typography>
              <Typography component="li" variant="body1" paragraph>
                <strong>{t("privacy.dataSharing.legal")}</strong>{" "}
                {t("privacy.dataSharing.legalText")}
              </Typography>
            </Box>
