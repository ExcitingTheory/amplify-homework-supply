...
export default {
    ...
    parameters: {
        ...
        docs: {
            description: {
                component: 'Unified generation workflow with preview and mask editing capabilities.',
            },
        },
    },
};
...
const mockGenerateAudio = async (prompt) => {
...
UnifiedImageGeneration.parameters = {
    docs: {
        description: {
            story: 'Unified modal workflow for image generation. Shows input, loading, and preview states in one modal.',
        },
    },
};
    ...
    return (
        <Box sx={{ p: 3, maxWidth: 900 }}>
            ...
            <Typography paragraph>
                Paint over areas you want to regenerate. The red mask indicates areas that will be changed.
            </Typography>

            {!showEditor ? (
                <Box>
                    <img src={sampleImage} alt="Sample" style={{ width: '100%', maxHeight: 400, objectFit: 'contain', marginBottom: 16 }} />
                    ...
                    {maskData && (
                        <Box sx={{ mt: 2 }}>
                            ...
                            <Typography variant="caption">
                                The mask has been created and can be sent to the API for targeted regeneration.
                            </Typography>
                        </Box>
                    )}
                </Box>
...
ImageMaskEditorDemo.parameters = {
    docs: {
        description: {
            story: 'Interactive image mask editor. Paint areas to regenerate, use eraser to refine, zoom for detail.',
        },
    },
};
...
CompleteWorkflow.parameters = {
    docs: {
        description: {
            story: 'Complete workflow: Generate → Preview → Mask Edit → Regenerate. Demonstrates how all components work together.',
        },
    },
};
...
export const FeatureDocumentation = () => (
    <Box sx={{ p: 3, maxWidth: 1000 }}>
        ...
        <ul>
            <li><strong>Input Mode:</strong> Enter description/prompt</li>
            <li><strong>Generating Mode:</strong> Shows loading indicator</li>
            <li><strong>Preview Mode:</strong> Display generated content with prompt shown</li>
            <li><strong>Cancel Confirmation:</strong> Confirms before discarding work</li>
            <li><strong>Edit & Regenerate:</strong> Modify and regenerate from preview</li>
        </ul>
        ...
        <ul>
            <li><strong>Brush Tool:</strong> Paint red mask over areas to change</li>
            <li><strong>Eraser Tool:</strong> Remove parts of the mask</li>
            <li><strong>Adjustable Brush Size:</strong> Slider from 5-100px</li>
            <li><strong>Undo/Redo:</strong> Full history support</li>
            <li><strong>Zoom & Pan:</strong> Zoom buttons and Shift+drag to pan</li>
            <li><strong>Clear Mask:</strong> Start over with one click</li>
        </ul>
...
FeatureDocumentation.parameters = {
    docs: {
        description: {
            story: 'Complete documentation of enhanced generation features and workflows.',
        },
    },
};
