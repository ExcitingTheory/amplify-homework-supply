    ...
    <Paper variant="outlined" sx={{ borderRadius: 2, overflow: "hidden" }}>
      ...
      >
        ...
        <Typography variant="subtitle2" sx={{ flexGrow: 1, fontWeight: 600 }}>
          {scriptTitle ||
            t("conversationPlaylistEditor.defaultTitle", "Conversation")}
        </Typography>
        <Chip
        ...
        {fileIDs.length === 0 ? (
          ...
          <List dense disablePadding>
            {fileIDs.map((id, idx) => {
              const file = files?.[id];
              return (
                <ListItem key={id} disableGutters sx={{ py: 0.25, gap: 1 }}>
                  <AudiotrackIcon
                    fontSize="small"
                  ...
                  <Tooltip
                    title={t(
                      "conversationPlaylistEditor.removeTrack",
                      "Remove track",
                    )}
                  >
                    <IconButton
          ...
          <List dense disablePadding>
            {dialogue.map((line) => (
              <ListItem
                key={line.id}
                disableGutters
                sx={{ py: 0.5, alignItems: "flex-start", gap: 1 }}
              >
                <ListItemText
                  primary={
                ...
                {editingLineId === line.id ? (
                  <IconButton
                    ...
                    aria-label={t(
                      "conversationPlaylistEditor.saveLine",
                      "Save",
                    )}
                  >
                  ...
                  <IconButton
                    ...
                    aria-label={t(
                      "conversationPlaylistEditor.editLine",
                      "Edit subtitle",
                    )}
                  >
