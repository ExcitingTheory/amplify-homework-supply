...
export default {
  title: '🔌 Editor Plugins/Workflow/Auto Embed',
      ...
      <LexicalComposer initialConfig={initialConfig}>
        <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
          ...
          <p style={{ color: '#666', marginBottom: '10px' }}>
            Type or paste a YouTube URL (e.g., https://www.youtube.com/watch?v=dQw4w9WgXcQ) 
            to see auto-embed suggestions appear!
          </p>
          <div style={{ 
...
export const EditableEmpty = {
  ...
  parameters: {
    docs: {
      description: {
        story: 'Paste a YouTube URL and press Enter to automatically embed the video.',
      },
    },
  },
};
