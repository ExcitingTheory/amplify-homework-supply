...
function convertAnswerElement(domNode) {
  ...
  const requestDefinition = domNode.getAttribute(
    "data-lexical-answer-request-definition",
  );
  const allowedInput =
    JSON.parse(domNode.getAttribute("data-lexical-answer-allowed-input")) || {};
  const promptMethod =
    JSON.parse(domNode.getAttribute("data-lexical-answer-prompt-method")) || {};
...
export class AnswerNode extends DecoratorNode {
  ...
  exportDOM() {
    ...
    element.setAttribute(
      "data-lexical-answer-request-definition",
      this.__requestDefinition,
    );
    element.setAttribute(
      "data-lexical-answer-allowed-input",
      JSON.stringify(this.__allowedInput),
    );
    element.setAttribute(
      "data-lexical-answer-prompt-method",
      JSON.stringify(this.__promptMethod),
    );
    return { element };
  }
