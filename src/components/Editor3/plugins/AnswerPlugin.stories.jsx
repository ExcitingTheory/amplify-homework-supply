...
export default {
  title: "✏️ Lesson Editor/Content Blocks/Answer",
...
export const EditableEmpty = {
  ...
  play: async ({ canvasElement }) => {
    ...
    await waitFor(
      () => {
        expect(
          canvas.getByRole("button", { name: /Insert Answer Block/i }),
        ).toBeInTheDocument();
      },
      { timeout: 3000 },
    );
...
export const EditableWithAnswer = {
  ...
  play: async ({ canvasElement }) => {
    ...
    await waitFor(
      () => {
        expect(
          canvas.getByText(/Vocabulary Answer Exercise/i),
        ).toBeInTheDocument();
      },
      { timeout: 5000 },
    );
    ...
    expect(
      canvas.getByText(/Provide translations or definitions/i),
    ).toBeInTheDocument();
  },
};
...
export const ReadOnlyWithAnswer = {
  ...
  play: async ({ canvasElement }) => {
    ...
    await waitFor(
      () => {
        expect(
          canvas.getByText(/Answer Plugin - Read-Only Mode/i),
        ).toBeInTheDocument();
      },
      { timeout: 5000 },
    );
