...
export default {
  title: '🔌 Editor Plugins/Interactions/Drag Drop Paste',
...
const EditableTemplate = ({ editorState }) => {
  ...
  const initialConfig = {
    ...
    nodes: [HeadingNode, QuoteNode, ListNode, ListItemNode, CodeNode, CodeHighlightNode, AutoLinkNode, LinkNode, ImageNode, PlaylistNode],
  };
      ...
      <LexicalComposer initialConfig={initialConfig}>
        <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
          ...
          <p style={{ color: '#666', marginBottom: '10px' }}>
            Drag and drop image or audio files into the editor, or paste them from clipboard.
            Supported formats: Images (PNG, JPEG, GIF, WebP), Audio (MP3)
          </p>
          <div style={{ 
          ...
          <div style={{ 
            ...
            <strong>Note:</strong> In Storybook, AWS S3 upload functionality is mocked. 
            In production, files are uploaded to AWS S3 with progress tracking.
          </div>
        </div>
      </LexicalComposer>
    </UnitProvider>
...
export const EditableEmpty = {
  ...
  parameters: {
    docs: {
      description: {
        story: 'Drag and drop image files or paste them from your clipboard to insert images.',
      },
    },
  },
};
