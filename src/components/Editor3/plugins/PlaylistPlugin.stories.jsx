...
export default {
  title: 'Editor3/Plugins/PlaylistPlugin',
...
function InsertPlaylistButton() {
  ...
  const handleClick = () => {
    editor.dispatchCommand(INSERT_PLAYLIST_COMMAND, ['video1', 'video2', 'video3']);
  };
...
const EditableTemplate = ({ editorState, showInsertButton }) => {
  const initialConfig = {
    ...
    nodes: [HeadingNode, QuoteNode, ListNode, ListItemNode, CodeNode, CodeHighlightNode, AutoLinkNode, LinkNode, PlaylistNode],
  };
