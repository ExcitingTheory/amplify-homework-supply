...
async function computeRealWaveform(audioUrl, samples = 600) {
  try {
    ...
    console.warn(
      "[Workbook.stories] Failed to compute waveform from",
      audioUrl,
      err,
    );
    return [];
...
export default {
  title: "✏️ Lesson Editor/Workbook",
  component: Workbook,
  parameters: {
    layout: "fullscreen",
    mockAuth: {
  ...
  summariesJSON: [
    {
      ...
      content:
        "Learn fundamental Japanese greetings written in kanji with hiragana pronunciation guides. This lesson covers time-appropriate greetings like 今日は (こんにちは - konnichiwa), お早うございます (ohayou gozaimasu), and 今晩は (こんばんは - konbanwa). Understanding both the written kanji forms and proper pronunciation is essential for Japanese literacy.",
      page_range: "1-3",
    },
    {
      title: "Core Vocabulary and Kanji Characters",
      content:
        "Master essential kanji vocabulary including 学生 (がくせい - student), 先生 (せんせい - teacher), and 日本語 (にほんご - Japanese language). Each kanji character has specific meanings and multiple pronunciations. Learning the hiragana readings alongside kanji builds comprehensive language skills.",
      page_range: "2-3",
    },
  ],
  objectivesJSON: [
    {
      objective:
        "Recognize and read common kanji characters with hiragana pronunciation",
    ...
    {
      objective:
        "Demonstrate proper pronunciation of Japanese phrases using hiragana guides",
      bloom_level: "application",
    },
    {
      objective:
        "Apply appropriate greetings and vocabulary in different social contexts",
      bloom_level: "application",
    },
  ],
  conceptsJSON: [
    {
      ...
      description:
        "Japanese kanji characters have hiragana pronunciation guides (furigana). Common greetings and vocabulary combine kanji and hiragana.",
      related_vocabulary: [
        "今日は (こんにちは)",
        "今晩は (こんばんは)",
        "学生 (がくせい)",
    ...
    },
    {
      ...
      description:
        "Different greetings are used depending on the time of day in Japanese",
      related_vocabulary: ["お早うございます", "今日は", "今晩は"],
    },
    {
      concept: "Politeness Levels",
      description:
        "Japanese has formal (丁寧語) and casual forms for most expressions",
      related_vocabulary: [
        "有難うございます",
        "ありがとう",
        "さようなら",
  ...
  questionsJSON: [
    {
      ...
      expectedAnswer:
        '今日は is read as "こんにちは" (konnichiwa) and means "hello" or "good afternoon." It is used as a greeting during the daytime.',
      hint: "Consider both the kanji characters and their hiragana reading.",
      type: "knowledge",
    },
    {
      question:
        "What is the difference between 学生 (がくせい) and 先生 (せんせい)?",
      expectedAnswer:
        '学生 (がくせい) means "student" - someone who is learning. 先生 (せんせい) means "teacher" or "professor" - someone who is teaching. The kanji 学 relates to learning/study, while 先 relates to going before or leading.',
      hint: "Look at the meanings of the individual kanji characters.",
      type: "analysis",
    },
    {
      question:
        "Why is it important to learn both kanji and hiragana readings?",
      expectedAnswer:
        "Kanji represents the meaning and origin of words, while hiragana provides the pronunciation. Knowing both allows you to read Japanese text, understand word meanings, and pronounce words correctly. Most Japanese writing uses a combination of kanji, hiragana, and katakana.",
    ...
    async () => {
      ...
      seedMockParsedContent([
        {
          ...
          vocabularyJSON: JSON.stringify(
            mockParsedContentJapaneseGreetings.vocabularyJSON,
          ),
          summariesJSON: JSON.stringify(
            mockParsedContentJapaneseGreetings.summariesJSON,
          ),
          objectivesJSON: JSON.stringify(
            mockParsedContentJapaneseGreetings.objectivesJSON,
          ),
          conceptsJSON: JSON.stringify(
            mockParsedContentJapaneseGreetings.conceptsJSON,
          ),
          questionsJSON: JSON.stringify(
            mockParsedContentJapaneseGreetings.questionsJSON,
          ),
            ...
            embedding: JSON.stringify([
              {
                ...
                text: "日本語 にほんご Japanese language",
              },
            ]),
            model: "text-embedding-3-small",
            dimensions: 128,
      ...
      seedMockQuestions([
            ...
            embedding: JSON.stringify([
              {
                ...
                text: "What does 今日は こんにちは mean? Hello A common greeting used during the day",
              },
            ]),
            model: "text-embedding-3-small",
            dimensions: 128,
            ...
            embedding: JSON.stringify([
              {
                ...
                text: "What does 今日は こんにちは mean? Goodbye This is incorrect",
              },
            ]),
            model: "text-embedding-3-small",
            dimensions: 128,
            ...
            embedding: JSON.stringify([
              {
                ...
                text: "What does 今日は こんにちは mean? Thank you This is incorrect",
              },
            ]),
            model: "text-embedding-3-small",
            dimensions: 128,
            ...
            embedding: JSON.stringify([
              {
                ...
                text: "What does 今日は こんにちは mean? Good morning This is incorrect - though also a greeting",
              },
            ]),
            model: "text-embedding-3-small",
            dimensions: 128,
            ...
            embedding: JSON.stringify([
              {
                ...
                text: "How do you say Good evening in Japanese? 今晩は こんばんは Said when greeting someone in the evening",
              },
            ]),
            model: "text-embedding-3-small",
            dimensions: 128,
            ...
            embedding: JSON.stringify([
              {
                ...
                text: "How do you say Good evening in Japanese? おはよう This is incorrect - this means good morning",
              },
            ]),
            model: "text-embedding-3-small",
            dimensions: 128,
            ...
            embedding: JSON.stringify([
              {
                ...
                text: "How do you say Good evening in Japanese? 今日は こんにちは This is incorrect - this is used during the day",
              },
            ]),
            model: "text-embedding-3-small",
            dimensions: 128,
            ...
            embedding: JSON.stringify([
              {
                ...
                text: "How do you say Good evening in Japanese? さようなら This is incorrect - this means goodbye",
              },
            ]),
            model: "text-embedding-3-small",
            dimensions: 128,
        ...
        },
        {
          ...
          answer:
            "Audio or text response demonstrating proper pronunciation of がくせい",
            ...
            embedding: JSON.stringify([
              {
                ...
                text: "Record yourself saying 学生 がくせい student Audio or text response demonstrating proper pronunciation Remember to pronounce both syllables clearly ga-ku-se-i",
              },
            ]),
            model: "text-embedding-3-small",
            dimensions: 128,
      ...
      seedMockUnit(
        {
          ...
          description:
            "Learn common Japanese greetings with kanji and hiragana. Practice with an interactive PDF lesson, quiz questions, vocabulary exercises, and audio pronunciation guides for 今日は (konnichiwa), お早うございます (ohayou gozaimasu), and essential vocabulary like 学生 (student), 先生 (teacher), and 日本語 (Japanese language).",
  ...
  loaders: [
    async () => {
      ...
      seedMockUnit({
        ...
        description:
          "Interactive workbook covering essential Japanese greetings and common animal names with multiple exercise types",
      ...
      seedMockGrade({
        ...
        data: JSON.stringify({
          ...
          "custom-q-1": {
            complete: true,
            userAnswer:
              "Common Japanese greetings include こんにちは (hello), ありがとう (thank you), and さようなら (goodbye). These are essential phrases used in daily conversation.",
            accuracy: 1,
            answerType: "text",
...
export const KitchenSink = {
  ...
  play: async ({ canvasElement }) => {
    ...
    await waitFor(
      () => {
        return (
          canvasElement.querySelector('[data-lexical-editor=\"true\"]') !== null
        );
      },
      { timeout: 3000 },
    );
    ...
    await waitFor(
      async () => {
        const meaningCards = canvasElement.querySelectorAll(
          '[draggable=\"true\"]',
        );
      ...
      {
        timeout: 2000,
        onTimeout: () => console.log("Meaning association cards not found"),
      },
    );
    ...
    await waitFor(
      async () => {
        const quizCheckboxes = canvasElement.querySelectorAll(
          'input[type=\"checkbox\"]',
        );
      ...
      {
        timeout: 2000,
        onTimeout: () => console.log("Quiz checkboxes not found"),
      },
    );
    ...
    await waitFor(
      async () => {
        const playButtons = canvasElement.querySelectorAll(
          '[aria-label=\"Play\"], [title*=\"play\" i]',
        );
        if (playButtons.length > 0) {
          ...
          setTimeout(async () => {
            const pauseButtons = canvasElement.querySelectorAll(
              '[aria-label=\"Pause\"], [title*=\"pause\" i]',
            );
            if (pauseButtons[0]) {
    ...
    await waitFor(
      async () => {
        const radioButtons = canvasElement.querySelectorAll(
          'input[type=\"radio\"]',
        );
      ...
      {
        timeout: 2000,
        onTimeout: () => console.log("Radio buttons not found"),
      },
    );

    // 6. Scroll through the workbook
    const workbookContainer = canvasElement.querySelector(
  ...
  loaders: [
    async () => {
      ...
      seedMockUnit({
        ...
        description:
          "Shows how DataPlugin loads workbook content and preserves student state",
