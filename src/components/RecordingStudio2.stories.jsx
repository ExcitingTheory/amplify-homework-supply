...
export const WithRecordedAnswer = {
      ...
      const mockUnitContextValue = React.useMemo(
        () => ({
          ...
          saveGrade: async (data) =>
            console.log("Mock saveGrade called with:", data),
        }),
        [],
      );
  ...
  parameters: {
    ...
    docs: {
      description: {
        story:
          "Shows RecordingStudio2 with a previously recorded answer displayed in an interactive AudioWaveformPlayer. Click play to hear the recording and see the waveform animate. Feedback shows the AI verification result.",
      },
    },
  },
};
