...
const meta: Meta<typeof PdfThumbnail> = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        component:
          "A component for rendering PDF page thumbnails using react-pdf. Useful for file listings, document references, and previews.",
      },
    },
  },
};
...
export const DocumentReferenceBadge: Story = {
  render: () => (
    <Box sx={{ display: "flex", alignItems: "center", gap: 1, p: 2 }}>
      <Typography variant="body1">This vocabulary word appears in:</Typography>
      <Paper
        sx={{
          display: "flex",
          alignItems: "center",
