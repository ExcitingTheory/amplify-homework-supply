...
import type {
  WrongAnswerAnnotation,
  GradeAttempt,
} from "./GradedWorkbookViewer";
...
const mockWrongAnswers: Record<string, WrongAnswerAnnotation[]> = {
  ...
  "block-meaning-1": [
    {
      blockId: "block-meaning-1",
      type: "meaning-association",
      wrongAnswer: "Permanent",
      attemptNumber: 1,
      timestamp: "2026-06-15T10:00:00Z",
    },
  ],
  "block-answer-1": [
    {
      blockId: "block-answer-1",
      type: "answer",
      wrongAnswer: "Plants eat sunlight",
      attemptNumber: 1,
      timestamp: "2026-06-15T10:00:00Z",
    },
    {
      blockId: "block-answer-1",
      type: "answer",
      wrongAnswer: "Light makes food for plants",
      attemptNumber: 2,
      timestamp: "2026-06-16T14:30:00Z",
    },
    {
...
export const MultipleBlocks: Story = {
  ...
  play: async ({ canvasElement }) => {
    ...
    expect(canvasElement.querySelectorAll("[class]").length).toBeGreaterThan(0);
  },
};
...
export const NoWrongAnswers: Story = {
  ...
  play: async ({ canvasElement }) => {
    const canvas = within(canvasElement);
    await canvas.findByText("No incorrect answers to display.");
  },
};
