        ...
        children: [
          {
            ...
            mode: "normal",
            style: "",
            text: "Learn basic Japanese greetings and their usage in daily life.",
            type: "text",
            version: 1,
          },
        ],
        ...
        children: [
          {
            ...
            mode: "normal",
            style: "",
            text: "Match the Japanese words to their English meanings in the exercise below.",
            type: "text",
            version: 1,
          },
        ],
        ...
        children: [
          {
            ...
            mode: "normal",
            style: "",
            text: "Write a short paragraph about when you would use each greeting.",
            type: "text",
            version: 1,
          },
        ],
  ...
  // Latest attempt (attempt 3) — much improved
  {
    ...
    data: {
      ...
      "custom-q-1": {
        ...
        accuracy: 85,
        userAnswer:
          "In Japan, you say こんにちは during the daytime. In the morning you use おはようございます, and at night こんばんは.",
        feedback:
          "Good explanation but could include more context about formality levels.",
      },
    },
    feedback: {
      overall:
        "Excellent improvement! You have shown great progress from your earlier attempts.",
      blockFeedback: {
      ...
      instructorNotes:
        "Student improved significantly between attempts. Ready for Unit 2.",
    },
  ...
  // Attempt 2 — some improvement
  {
    ...
    data: {
      ...
      "custom-q-1": {
        ...
        feedback:
          "Correct but too brief. Add more greetings and when to use them.",
      },
    },
    feedback: {
      overall:
        "Some improvement from attempt 1. Keep studying the difference between farewell and gratitude expressions.",
      blockFeedback: {
  ...
  // Attempt 1 — first try, lowest score
  {
    ...
    data: {
      ...
      "custom-q-1": {
        ...
        feedback:
          "Very brief answer. The romanization is also slightly off (konnichiwa with double n). Please elaborate on other greetings.",
      },
    },
    feedback: {
      overall:
        "First attempt shows you need more study time with the vocabulary.",
      blockFeedback: {
...
const meta: Meta<typeof GradedWorkbookViewer> = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        component:
          "Instructor view of a student's completed workbook showing all attempts, wrong answers in a gutter sidebar, and moderation status.",
      },
    },
  },
  argTypes: {
