...
import { processAndUploadTake } from "../utils/processAndUploadTake";
...
export default forwardRef(function RecordingStudio3(
  ...
  return (
    <RecordingStudio3View
      ...
      identityId={identityId}
      readOnly={readOnly}
      handleBatchGenerateTTS={handleBatchGenerateTTS}
      handleImportJSON={handleImportJSON}
      handleExportJSON={handleExportJSON}
      handleFountainChange={handleFountainChange}
      handlePromptSubmit={handlePromptSubmit}
      handleUpdateDialogueLine={handleUpdateDialogueLine}
      handleAudioWaveformRecordingComplete={
        handleAudioWaveformRecordingComplete
      }
      handleGenerateTTS={handleGenerateTTS}
      handleFiltersChange={handleFiltersChange}
      handleSetActiveTake={handleSetActiveTake}
      handleRollbackTake={handleRollbackTake}
      ...
      confirmDeleteTake={confirmDeleteTake}
    />
  );
});
