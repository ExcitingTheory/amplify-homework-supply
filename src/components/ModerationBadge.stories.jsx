...
export default {
  title: "🧩 UI Components/Moderation Badge",
  ...
  parameters: {
    ...
    docs: {
      description: {
        component:
          "Displays content moderation status as a compact badge. Shows warnings for flagged content with tooltip details.",
      },
    },
  },
  decorators: [
...
export const ApprovedWithDetails = {
  ...
  parameters: {
    docs: {
      description: {
        story:
          "When showDetails is true, approved content shows a success badge.",
      },
    },
  },
};
