  ...
  return (
    ...
    >
      ...
      >
        <Box sx={{ display: "flex", alignItems: "center", gap: 1 }}>
          <Typography variant="subtitle1" sx={{ fontWeight: 600 }}>
            ...
            {t("chatSidebar.contentPreview.generatedContent", {
        ...
        <Stack direction="row" spacing={0.5}>
          <Tooltip
            title={
              copied
                ? t("chatSidebar.contentPreview.copied")
                : t("chatSidebar.contentPreview.copyToClipboard")
            }
          >
            <IconButton
              size="small"
      ...
      >
        ...
        {viewMode === "raw" && (
          <Box sx={{ bgcolor: "custom.codeBlock", borderRadius: 1, p: 2 }}>
            <SyntaxHighlight
      ...
      {showInsertButton && onInsert && (
        ...
        >
          ...
          >
            {inserted
              ? t("chatSidebar.contentPreview.inserted")
              : t("chatSidebar.contentPreview.insertIntoEditor")}
          </Button>
        </Box>
      )}
    </Paper>
