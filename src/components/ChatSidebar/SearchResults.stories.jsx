...
const mockFiles = [
    {
        ...
        description: 'Introduction to **Japanese particles** (は, が, を) and their usage in sentences. Includes practice examples and common mistakes.',
        page: 12,
        similarity: 0.92
    },
    {
        ...
        description: 'Complete guide to **verb conjugation** patterns in Japanese, covering present, past, negative, and polite forms.',
        page: 5,
        similarity: 0.78
    },
    {
        ...
        description: 'Effective strategies for learning and remembering kanji characters.',
        page: 3,
        similarity: 0.55
    }
];
...
const mockWords = [
    ...
    },
    {
        ...
        definition: 'student; typically refers to **high school or university students**',
        similarity: 0.88
    },
    {
        id: 'word-3',
...
const mockQuestions = [
    {
        ...
        answer: 'は marks the **topic** of the sentence (what you\'re talking about), while が marks the **subject** (who/what performs the action). は is used for contrast or known information, が for new information or emphasis.',
        similarity: 0.91
    },
    {
        id: 'question-2',
        ...
        answer: 'Remove る and add た. For example: 食べる → 食べた (taberu → tabeta)',
        similarity: 0.76
    },
    {
        id: 'question-3',
        ...
        answer: 'Hiragana (phonetic syllabary), Katakana (phonetic syllabary for foreign words), and Kanji (Chinese characters)',
        similarity: 0.58
    }
];
...
const mockSections = [
    {
        ...
        description: 'Beginner Japanese class covering **hiragana, katakana**, basic grammar, and conversational skills.',
        joinCode: 'JPH101',
        similarity: 0.89
    },
    {
    ...
    },
    {
        ...
        description: 'Test preparation class for the **Japanese Language Proficiency Test** N3 level.',
        joinCode: 'N3PREP',
        similarity: 0.64
    }
];
...
const mockUnits = [
    {
        ...
        description: 'Learn the fundamental **Japanese particles**: は, が, を, に, で, and their basic usage patterns.',
        published: true,
        similarity: 0.94
    },
    {
        ...
        description: 'Common words and phrases for describing daily activities and schedules.',
        published: true,
        similarity: 0.82
    },
    {
        ...
        description: 'Introduction to Japanese honorific language system including **敬語 (keigo)** levels.',
        published: false,
        similarity: 0.59
    }
];
...
export const AllResultTypes = {
    args: {
        results: [...mockFiles, ...mockWords, ...mockQuestions, ...mockSections, ...mockUnits],
        unitId: 'unit-123',
...
export const WithoutUnitId = {
    args: {
        results: [...mockFiles.slice(0, 1), ...mockWords.slice(0, 1), ...mockQuestions.slice(0, 1)],
        unitId: null,
        searchQuery: 'test',
        tabHandlers: mockTabHandlers,
        onInsertWord: (word) => console.log('Insert word:', word.phrase),
