      ...
      <form onSubmit={addDueDate} sx={{ width: '100%' }}>
        ...
        <DialogContent>
          ...
          <FormControl sx={{ width: '90%', margin: '1rem' }}>
            ...
            <FormHelperText>{t('sectionAssigner.selectSectionHelper')}</FormHelperText>
          </FormControl>
          {/* </SectionProvider> */}
        ...
        <div style={{ margin: '1rem' }} onClick={(e) => e.stopPropagation()}>
          ...
          <h4 style={{ margin: '1rem' }}>
            {t('sectionAssigner.assignedToSections')}
          </h4>
