...
export const Default: Story = {
  ...
  loaders: [
    createVocabularyLoader("mock-doc-1", [
      {
        word: "光合成",
        phonetic: "こうごうせい",
        definition:
          "Photosynthesis - the process by which plants convert light energy into chemical energy",
        context: "植物は光合成によってエネルギーを作ります。",
        page: 1,
      },
      {
        word: "葉緑体",
        ...
        context: "葉緑体は光合成の場所です。",
        page: 1,
      },
      {
        word: "二酸化炭素",
        phonetic: "にさんかたんそ",
        definition: "Carbon dioxide - gas used by plants in photosynthesis",
        context: "植物は二酸化炭素を吸収します。",
        page: 2,
      },
      {
        word: "酸素",
        phonetic: "さんそ",
        definition: "Oxygen - gas released by plants during photosynthesis",
        context: "光合成で酸素が作られます。",
        page: 2,
      },
      {
        word: "グルコース",
        phonetic: "ぐるこーす",
        definition: "Glucose - simple sugar produced by photosynthesis",
        context: "グルコースは植物の栄養源です。",
        page: 3,
      },
      {
        word: "太陽光",
        phonetic: "たいようこう",
        definition:
          "Sunlight - light energy from the sun used in photosynthesis",
        context: "太陽光は光合成に必要です。",
        page: 3,
      },
      {
        word: "水分",
        phonetic: "すいぶん",
        definition: "Water - essential component for photosynthesis",
        context: "植物は根から水分を吸収します。",
        page: 4,
      },
      {
        word: "細胞",
        phonetic: "さいぼう",
        definition: "Cell - basic unit of life in organisms",
        context: "植物の細胞には葉緑体があります。",
        page: 4,
      },
      {
        word: "栄養素",
        phonetic: "えいようそ",
        definition: "Nutrient - substance providing nourishment",
        context: "光合成で作られた栄養素は植物全体に運ばれます。",
        page: 5,
      },
      {
        word: "生態系",
        phonetic: "せいたいけい",
        definition: "Ecosystem - biological community of interacting organisms",
        context: "植物は生態系の基礎です。",
        page: 5,
      },
    ]),
  ...
  parameters: {
    docs: {
      description: {
        story:
          "Default view with extracted vocabulary ready for review. Click any row to expand and edit inline. Changes auto-save after 1 second.",
      },
    },
  },
};
...
export const WithSearchHighlight: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story:
          'Search term "光合成" is highlighted in yellow across all fields. Only matching items are shown.',
      },
    },
  },
};
...
export const LargeList: Story = {
  ...
  render: (args) => (
    <Box sx={{ height: "80vh", display: "flex", flexDirection: "column" }}>
      <Paper sx={{ p: 2, mb: 2, bgcolor: "info.light" }}>
        <strong>Performance Test:</strong> This list contains 100 vocabulary
        items. Virtual scrolling ensures smooth performance by only rendering
        visible items. Scroll to see smooth performance even with large
        datasets.
      </Paper>
      <VocabularyReview2 {...args} />
    </Box>
  ...
  parameters: {
    docs: {
      description: {
        story:
          "Demonstrates virtual scrolling with 100 items. Only visible items are rendered for optimal performance.",
      },
    },
  },
};
...
export const AlreadyImported: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story:
          "Shows the interface when vocabulary has already been imported. Import button and checkboxes are hidden.",
      },
    },
  },
};
...
export const MinimalData: Story = {
  ...
  loaders: [
    createVocabularyLoader("mock-doc-minimal", [
  ...
  parameters: {
    docs: {
      description: {
        story:
          "Vocabulary items with only required fields (word and definition). Optional context and phonetic fields are omitted.",
      },
    },
  },
};
...
export const NoVocabulary: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story:
          "Empty state shown when the PDF contains no extractable vocabulary.",
      },
    },
  },
};
