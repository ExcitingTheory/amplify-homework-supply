...
const mockSections = [
  {
    ...
    description: "MWF 8:00am",
    studentCount: 25,
  },
  {
    id: "sec-2",
    name: "Period 3 - Chemistry",
    description: "TTh 10:30am",
    studentCount: 30,
  },
];
    ...
    campaigns: [
      {
        ...
        setting: "A world where code is law.",
      },
    ],
    squads: [
    ...
    easterEggs: [
      {
        ...
        message: "Found the hidden bug!",
        xpReward: 50,
      },
      {
        id: "e2",
        type: "KEYWORD" as const,
        message: "Typed the secret word!",
        xpReward: 75,
        keyword: "konami",
      },
    ],
...
export const AccordionInteraction: Story = {
  args: {
    ...
    selectedSectionId: "sec-1",
    availableUnits: mockUnits,
    skills: [{ id: "s1", title: "Variables & Types", xpReward: 100 }],
    campaigns: [],
    squads: [],
    easterEggs: [],
    bossBattles: [],
