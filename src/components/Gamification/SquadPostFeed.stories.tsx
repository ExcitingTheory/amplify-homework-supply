        ...
        children: [
          {
            ...
            mode: "normal",
            style: "",
            text: "Hey team! Let's coordinate our practice for this week.",
            type: "text",
            version: 1,
          },
        ],
            ...
            children: [
              {
                ...
                mode: "normal",
                style: "",
                text: "Grammar drills on irregular verbs",
                type: "text",
                version: 1,
              },
            ],
...
export const WithPosts: Story = {
  ...
  play: async ({ canvasElement }) => {
    ...
    await expect(
      await canvas.findByText("Weekly Practice Plan"),
    ).toBeInTheDocument();
    await expect(
      await canvas.findByText("Great job on the quiz!"),
    ).toBeInTheDocument();
  },
};
...
export const EmptyFeed: Story = {
  ...
  play: async ({ canvasElement }) => {
    const canvas = within(canvasElement);
    expect(canvas.queryByText("Weekly Practice Plan")).toBeNull();
  },
};
