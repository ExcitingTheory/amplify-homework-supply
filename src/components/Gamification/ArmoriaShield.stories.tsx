...
export const FallbackInitials: Story = {
  ...
  play: async ({ canvasElement }) => {
    ...
    await canvas.findByText("Phoenix Squad");
  },
};
...
export const UnlockedNoDesign: Story = {
  ...
  play: async ({ canvasElement }) => {
    const canvas = within(canvasElement);
    await canvas.findByText(/Design Coat of Arms/i);
  },
};
...
export const CustomCrest: Story = {
  ...
  play: async ({ canvasElement }) => {
    const canvas = within(canvasElement);
    expect(
      canvas.getByRole("img", { name: /coat of arms/i }),
    ).toBeInTheDocument();
  },
};
...
export const LargeSize: Story = {
  ...
  play: async ({ canvasElement }) => {
    ...
    await canvas.findByText("Dragon Knights");
  },
};
