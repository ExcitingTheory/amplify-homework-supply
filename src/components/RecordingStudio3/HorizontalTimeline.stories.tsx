...
const mockThreeSpeakers = {
  ...
  dialogue: [
    ...
    },
    {
      ...
      speaker: "akiko",
      text: "こんにちは！",
      timing: { start: 3, end: 4.5 },
      direction: "bow slightly",
      emotion: "cheerful",
      takes: [],
      activeTakeIndex: null,
    },
...
export const TwoSpeakers = {
  args: {
    ...
    onRecordingComplete: (blob: any, waveform: any) =>
      console.log("Recording complete:", blob, waveform),
    readOnly: false,
  },
