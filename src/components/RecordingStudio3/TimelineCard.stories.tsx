...
export const Default: Story = {
  args: {
    line: { id: 'line-1', text: 'Hello, welcome to today\'s lesson.', emotion: 'neutral' },
...
export const LongText: Story = {
  args: {
    line: { id: 'line-2', text: 'This is a much longer dialogue line that demonstrates how the timeline card handles overflow text in constrained width scenarios.', emotion: 'excited' },
