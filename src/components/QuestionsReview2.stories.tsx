...
const createQuestionLoader = (documentId: string, questions: any[]) => {
  return async () => {
    ...
    } = await import("../../.storybook/__mocks__/aws-amplify-data.js");

    // Clear existing data
    Object.keys(mockDocuments).forEach((k) => delete (mockDocuments as any)[k]);
    Object.keys(mockParsedContent).forEach(
      (k) => delete (mockParsedContent as any)[k],
    );
...
const meta: Meta<typeof QuestionsReview2> = {
  title: "📁 Content Management/Questions Review",
...
export const Default: Story = {
  ...
  loaders: [
    createQuestionLoader("mock-doc-1", [
      {
      ...
      {
        prompt: "Describe the role of chloroplasts in photosynthesis.",
        answer:
          "Chloroplasts are organelles where photosynthesis occurs, containing chlorophyll that captures light energy.",
        hint: "Where does photosynthesis happen?",
        type: "short_answer",
        difficulty: "medium",
        page: 2,
      },
      {
        prompt: "What gases are involved in photosynthesis?",
        answer:
      ...
      {
        prompt: "Explain the importance of photosynthesis in ecosystems.",
        answer:
          "Photosynthesis provides oxygen for organisms and forms the base of food chains.",
        hint: "Think about the broader impact",
        type: "essay",
        difficulty: "hard",
        page: 3,
        hasAudio: true,
      },
      {
        ...
        answer: "Glucose is the primary product of photosynthesis.",
        type: "short_answer",
        difficulty: "medium",
        page: 4,
        hasImage: true,
  ...
  play: async ({ canvasElement }) => {
    ...
    expect(
      canvas.getByText(/Describe the role of chloroplasts/i),
    ).toBeInTheDocument();
  ...
  parameters: {
    docs: {
      description: {
        story:
          "Default view with extracted questions ready for review. Click any row to expand and edit inline. Changes auto-save after 1 second.",
      },
    },
  },
};
...
export const WithSearchHighlight: Story = {
  ...
  play: async ({ canvasElement }) => {
    ...
    await waitFor(
      () => {
        const container =
          canvasElement.querySelector("[data-lexical-editor]") || canvasElement;
    ...
    const container2 =
      canvasElement.querySelector(".MuiBox-root") || canvasElement;
  ...
  parameters: {
    docs: {
      description: {
        story:
          'Search term "photosynthesis" is highlighted in yellow across all fields. Only matching items are shown.',
      },
    },
  },
};
...
export const LargeList: Story = {
  ...
  render: (args) => (
    <Box sx={{ height: "80vh", display: "flex", flexDirection: "column" }}>
      <Paper sx={{ p: 2, mb: 2, bgcolor: "info.light" }}>
        ...
        Virtual scrolling ensures smooth performance by only rendering visible
        items. Scroll to see smooth performance even with large datasets.
      </Paper>
      <QuestionsReview2 {...args} />
    </Box>
  ),
  ...
  parameters: {
    docs: {
      description: {
        story:
          "Demonstrates virtual scrolling with 50 items. Only visible items are rendered for optimal performance.",
      },
    },
  },
};
...
export const EssayQuestions: Story = {
  ...
  loaders: [
    createQuestionLoader("mock-doc-essay", [
      {
        prompt: "Explain the process of photosynthesis in detail.",
        answer:
          "Photosynthesis is a complex process where plants convert light energy into chemical energy through a series of reactions.",
        type: "essay",
        difficulty: "medium",
        page: 1,
      },
      {
        prompt: "Discuss the importance of photosynthesis for life on Earth.",
        answer:
          "Photosynthesis is essential as it produces oxygen and forms the base of most food chains.",
        type: "essay",
        difficulty: "easy",
        page: 2,
      },
      {
        prompt: "Compare and contrast cellular respiration and photosynthesis.",
        answer:
          "While photosynthesis stores energy, cellular respiration releases it. Both involve electron transport chains.",
        type: "essay",
        difficulty: "hard",
        page: 3,
      },
  ...
  play: async ({ canvasElement }) => {
    ...
    await waitFor(
      () => {
        expect(
          canvas.getByText(/Explain the process of photosynthesis/i),
        ).toBeInTheDocument();
      },
      { timeout: 5000 },
    );
    ...
    const essayQuestions = canvasElement.querySelectorAll(
      '[class*="MuiBox-root"]',
    );
  ...
  parameters: {
    docs: {
      description: {
        story:
          "Collection of essay-type questions requiring detailed responses. All questions have the primary blue badge.",
      },
    },
  },
};
...
export const ComprehensionQuestions: Story = {
  ...
  loaders: [
    createQuestionLoader("mock-doc-comprehension", [
      {
        prompt: "What gases are exchanged during photosynthesis?",
      ...
      {
        prompt: "Where in plant cells does photosynthesis occur?",
        answer: "Photosynthesis occurs in the chloroplasts.",
        type: "comprehension",
        difficulty: "easy",
        page: 2,
      },
      {
        ...
        answer: "Glucose is the main product of photosynthesis.",
        type: "comprehension",
        difficulty: "medium",
        page: 3,
      },
  ...
  parameters: {
    docs: {
      description: {
        story:
          "Reading comprehension questions. All questions have the secondary purple badge.",
      },
    },
  },
};
...
export const MixedDifficulty: Story = {
  ...
  loaders: [
    createQuestionLoader("mock-doc-difficulty", [
      {
      ...
      {
        prompt: "Describe the light-dependent reactions.",
        answer:
      ...
      {
        prompt: "Explain the Calvin cycle and its role in carbon fixation.",
        answer:
          "The Calvin cycle uses ATP and NADPH to fix CO2 into organic compounds through a complex series of enzymatic reactions.",
        type: "essay",
        difficulty: "hard",
        page: 3,
      },
  ...
  parameters: {
    docs: {
      description: {
        story:
          "Questions with varying difficulty levels: easy (green), medium (yellow), hard (red).",
      },
    },
  },
};
...
export const WithMediaAttachments: Story = {
  ...
  loaders: [
    createQuestionLoader("mock-doc-media", [
      {
        prompt: "Listen to the explanation and summarize the process.",
        answer:
          "The process involves capturing light energy and converting it to chemical energy.",
        type: "essay",
        difficulty: "medium",
        page: 1,
        hasAudio: true,
      ...
      {
        prompt: "Based on the diagram, identify the key structures.",
        answer:
          "The key structures include chloroplasts, thylakoids, and stroma.",
        type: "comprehension",
        difficulty: "easy",
        page: 2,
        hasImage: true,
      ...
      {
        prompt: "Analyze the image and describe the electron transport chain.",
        answer:
          "The electron transport chain moves electrons through protein complexes, creating a proton gradient.",
        type: "essay",
        difficulty: "hard",
        page: 3,
        hasImage: true,
  ...
  play: async ({ canvasElement }) => {
    ...
    await waitFor(
      () => {
        expect(
          canvas.getByText(/Listen to the explanation/i),
        ).toBeInTheDocument();
      },
      { timeout: 5000 },
    );
  ...
  parameters: {
    docs: {
      description: {
        story:
          "Questions with audio (microphone icon) and image (image icon) attachments.",
      },
    },
  },
};
...
export const AlreadyImported: Story = {
  ...
  loaders: [
    async () => {
      ...
      Object.keys(mockDocuments).forEach(
        (k) => delete (mockDocuments as any)[k],
      );
      Object.keys(mockParsedContent).forEach(
        (k) => delete (mockParsedContent as any)[k],
      );
      ...
      seedMockParsedContent([
        {
          ...
          questionsJSON: JSON.stringify([
            {
              prompt: "What is photosynthesis?",
              answer: "The process of converting light to energy.",
              type: "short_answer",
              difficulty: "easy",
              page: 1,
            },
  ...
  parameters: {
    docs: {
      description: {
        story:
          "Shows the interface when questions have already been imported. Import button and checkboxes are hidden.",
      },
    },
  },
};
...
export const MinimalData: Story = {
  ...
  loaders: [
    createQuestionLoader("mock-doc-minimal", [
      {
        prompt: "What is photosynthesis?",
      ...
      },
      {
        ...
        answer: "Light, water, and carbon dioxide.",
      },
    ]),
  ],
  render: (args) => (
  ...
  parameters: {
    docs: {
      description: {
        story:
          "Questions with only required fields (prompt and answer). Optional hint, type, and difficulty fields are omitted.",
      },
    },
  },
};
...
export const NoQuestions: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story:
          "Empty state shown when the PDF contains no extractable questions.",
      },
    },
  },
};
...
export const WithSummariesExpanded: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story:
          "Document includes extracted summaries and learning objectives. Click the toggle to expand/collapse.",
      },
    },
  },
};
...
export const Playground: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story:
          "Interactive playground. Try expanding items, editing fields, selecting items, and using search. Use the controls below to adjust props.",
      },
    },
  },
};
...
export const BadgeShowcase: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story:
          "Demonstrates all badge types and color coding used in the component.",
      },
    },
  },
};
