...
export default function SettingsUpdateForm(props) {
  ...
  const resetStateValues = () => {
    ...
    setAutoAnalyzeDocuments(cleanValues.autoAnalyzeDocuments);
    setDocumentAnalysisModel(cleanValues.documentAnalysisModel);
    setEditorTheme(cleanValues.editorTheme);
    setEditorFontSize(cleanValues.editorFontSize);
    setDefaultAIModel(cleanValues.defaultAIModel);
    setAssistantVoice(cleanValues.assistantVoice);
    setEmailNotifications(cleanValues.emailNotifications);
    setWebhookNotifications(cleanValues.webhookNotifications);
