...
export declare type AIFeedbackCreateFormInputValues = {
    owner?: string;
    identityId?: string;
    contentType?: string;
    feedbackType?: string;
...
export declare type AIFeedbackCreateFormValidationValues = {
...
export declare type AIFeedbackCreateFormOverridesProps = {
    AIFeedbackCreateFormGrid?: PrimitiveOverrideProps<GridProps>;
...
export declare type AIFeedbackCreateFormProps = React.PropsWithChildren<{
    overrides?: AIFeedbackCreateFormOverridesProps | undefined | null;
} & {
    clearOnSuccess?: boolean;
    onSubmit?: (fields: AIFeedbackCreateFormInputValues) => AIFeedbackCreateFormInputValues;
    onSuccess?: (fields: AIFeedbackCreateFormInputValues) => void;
    onError?: (fields: AIFeedbackCreateFormInputValues, errorMessage: string) => void;
    onChange?: (fields: AIFeedbackCreateFormInputValues) => AIFeedbackCreateFormInputValues;
    onValidate?: AIFeedbackCreateFormValidationValues;
} & React.CSSProperties>;
export default function AIFeedbackCreateForm(props: AIFeedbackCreateFormProps): React.ReactElement;
