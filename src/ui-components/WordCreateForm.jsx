...
export default function WordCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
  ...
  const resetStateValues = () => {
    ...
    setPronunciation(initialValues.pronunciation);
    ...
    setDefinitionAudio(initialValues.definitionAudio);
    setCurrentDefinitionAudioValue("");
    setDefinitionWaveformData(initialValues.definitionWaveformData);
    setRubyTags(initialValues.rubyTags);
    ...
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await DataStore.save(new Word(modelFields));
          if (onSuccess) {
      ...
      {...getOverrideProps(overrides, "WordCreateForm")}
      {...rest}
    >
      <TextField
        label="Phrase"
