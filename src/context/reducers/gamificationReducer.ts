...
export interface GroupChallengeInfo {
  ...
  contributions?: Array<{ studentId: string; xpContributed: number; contributedAt: string }>
}
...
export function gamificationReducer(
  ...
  switch (action.type) {
    ...
    case actionTypes.SET_RAW_CAMPAIGNS:
      return { ...state, rawCampaigns: action.payload, campaignsLoading: false }
    case actionTypes.SET_RAW_CHALLENGES:
      return { ...state, rawChallenges: action.payload, challengesLoading: false }
    ...
    case actionTypes.SET_RAW_MEMBERSHIPS:
      return { ...state, rawMemberships: action.payload, membershipsLoading: false }
    ...
    case actionTypes.SET_RAW_SKILL_PROGRESS:
      return { ...state, rawSkillProgress: action.payload, skillProgressLoading: false }
    ...
    case actionTypes.SET_RAW_ASSIGNMENTS:
      return { ...state, rawAssignments: action.payload, assignmentsLoading: false }
