...
import { NailedItSection, AvatarSection } from '../../app/[locale]/profile/[username]/ProfileClientSections';
...
export const RecycleBin: Story = {
  ...
  parameters: {
    mockAuth: {
      ...
      session: { username: 'teacher-1', identityId: 'identity-teacher-1', groups: ['Admins', 'Instructors'] },
    },
...
export const Leaderboard: Story = {
  ...
  render: () => (
    <LiveLeaderboard
      initialEntries={[
        { studentId: 'student-alice-sub', studentName: 'Alice Johnson', avatarColor: '#6366f1', totalXP: 2450, level: 5, currentStreak: 7, completedAssignments: 12, onTimeSubmissions: 11, totalSubmissions: 12 },
        { studentId: 'student-bob-sub', studentName: 'Bob Smith', avatarColor: '#f59e0b', totalXP: 2100, level: 4, currentStreak: 3, completedAssignments: 10, onTimeSubmissions: 8, totalSubmissions: 10 },
        { studentId: 'student-carol-sub', studentName: 'Carol Davis', avatarColor: '#10b981', totalXP: 1800, level: 4, currentStreak: 5, completedAssignments: 9, onTimeSubmissions: 9, totalSubmissions: 9 },
        { studentId: 'student-dave-sub', studentName: 'Dave Wilson', avatarColor: '#ef4444', totalXP: 1500, level: 3, currentStreak: 1, completedAssignments: 7, onTimeSubmissions: 5, totalSubmissions: 7 },
        { studentId: 'student-eve-sub', studentName: 'Eve Martinez', avatarColor: '#8b5cf6', totalXP: 1200, level: 3, currentStreak: 14, completedAssignments: 6, onTimeSubmissions: 6, totalSubmissions: 6 },
      ]}
    />
  ),
  parameters: {
...
export const AdminAnalytics: Story = {
  ...
  parameters: {
    mockAuth: {
      ...
      session: { username: 'admin-1', identityId: 'identity-admin-1', groups: ['Admins', 'Instructors'] },
    },
...
export const Offline: Story = {
  render: () => (
    <div style={{ minHeight: '100vh', display: 'flex', alignItems: 'center', justifyContent: 'center', flexDirection: 'column', gap: '1rem' }}>
      ...
      <p style={{ color: '#666' }}>Check your internet connection and try again.</p>
...
export const Privacy: Story = {
  render: () => (
    <div style={{ maxWidth: 720, margin: '2rem auto', padding: '2rem', fontFamily: 'sans-serif' }}>
      <h1>Privacy Policy</h1>
      <p style={{ color: '#555' }}>Last updated: January 2025</p>
      <h2>Data Collection</h2>
      <p>We collect information you provide directly, including your name, email address, and learning progress data.</p>
      <h2>How We Use Your Data</h2>
      <p>Your data is used to provide personalized learning experiences, track progress, and improve our platform.</p>
      <h2>Data Storage</h2>
      <p>All data is stored securely on AWS infrastructure with encryption at rest and in transit.</p>
      <h2>Your Rights</h2>
      <p>You may request deletion of your data at any time by contacting support.</p>
    </div>
  ),
  parameters: {
