...
const QUIZ_DESTINATIONS: { label: string; storyId: string }[] = [
  ...
  { label: 'Section Detail', storyId: '📄-pages-application-pages--section-detail' },
  ...
  { label: 'Keyboard Shortcuts', storyId: '🏠-getting-started-keyboard-shortcuts--default' },
  { label: 'Task Completion Examples', storyId: '🏠-getting-started-onboarding-task-completion-examples--auto-detect-task-completion' },
  { label: 'Translation Demo', storyId: 'translation-mode-demo--default' },
  { label: 'Translation Demo (Editor)', storyId: 'translation-mode-demo--editor-namespace' },
  { label: 'Translation Demo (Auth)', storyId: 'translation-mode-demo--auth-namespace' },
];
        ...
        <Card>
          <CardContent>
            ...
            <Typography variant="body2" sx={{ color: 'text.secondary', mb: 2 }}>
              Select the destination your onboarding task asks for. Each button opens the exact Storybook page used by Quiz Mode tasks.
            </Typography>
            <Divider sx={{ mb: 2 }} />
