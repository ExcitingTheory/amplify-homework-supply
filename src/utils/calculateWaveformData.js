 ...
 */
import { WAVEFORM_DATA_DEFAULTS } from "./waveformDefaults";

export async function calculateWaveformData(
  audioSource,
  samples = /** @type {number} */ (WAVEFORM_DATA_DEFAULTS.sampleCount),
) {
  try {
 ...
 */
export async function calculateWaveformDataWithDuration(
  audioSource,
  samples = /** @type {number} */ (WAVEFORM_DATA_DEFAULTS.sampleCount),
) {
  let arrayBuffer;
